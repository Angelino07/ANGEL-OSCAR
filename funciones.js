document.addEventListener('DOMContentLoaded', () => {
    ...
    const productsData = {
        "pc-gamer": [
            { name: "PC Gamer 1", image: "img/pc 1.png" }, 
            { name: "PC Gamer 2", image: "img/pc 2.png" },
            { name: "PC Gamer 3", image: "img/pc 3.png" },
            { name: "PC Gamer 4", image: "img/pc 4.png" }
        ],
        "playstation-5": [
            { name: "PlayStation 5 ", image: "img/play 1.jpg" }
        ],
        "xbox-series-s": [
            { name: "Xbox Series S ", image: "img/xbox s.png" },
            { name: "Xbox Series S ", image: "img/xbox x.png" }
        ],
        "nintendo-switch": [
            { name: "Nintendo Switch", image: "img/nintendo.png" }
        ]
    };
